      ...
      <div class="rong">
       ...
       <div class="you">
        ...
        @foreach($lou->goods as $louGoods)
         <div class="you1 good">
          <a target="_blank" href="/goods/{{$good->id}}"   title="{{$louGoods->title}}"> 
          ...
          <a class="money"  target="_blank" href="/goods/{{$good->id}}"  title="{{$louGoods->title}}">{{number_format($louGoods->price)}}元
          </a>
